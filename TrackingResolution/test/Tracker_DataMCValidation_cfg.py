...
for i in range(1):
    filenames.append('file:/eos/user/b/borzari/TrackingRootFile/definitive_allRECO_reRECO_9layers_'+options.inputFiles[i]+'.root')
...
process.DQMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:test_usualReRECO_definitive_allRECO_DQMMod_'+str(options.layersThreshold)+'layers_'+options.outputFile),
...
process.trackingResolution = DQMEDAnalyzer("TrackingResolutionMod",
    ...
    tracksRerecoInputTag     = cms.untracked.InputTag("generalTracks"+str(layers), "", "reRECO"),
